...
class TestCreateBankAccount(unittest.TestCase):
    def test_przelew_przychodzacy(self):
        konto9=Konto("Dariusz", "Januszewski", "12345678999", 500)
    ...
    def test_przelew_wychodzacy_wystarczajace_srodki(self):
        konto8=Konto("Dariusz", "Januszewski", "12345678999", 500)
    ...
    def test_przelew_wychodzacy_niewystarczajace_srodki(self):
        konto10=Konto("Dariusz", "Januszewski", "12345678999", 50)
    ...
    def test_seria_przelewow(self):
        konto11=Konto("Dariusz", "Januszewski", "12345678999", 600)
